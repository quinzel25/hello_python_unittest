...
class TestStudentLists(TestCase):
    ...
    def test_add_multiple_students_remove_ghost(self):
        test_class = ClassList(2)
        test_class.add_student('Test Student')
        test_class.add_student('Test Student2')
        test_class.add_student('Test Student3')
        with self.assertRaises(StudentError):
            test_class.remove_student('Test Student4')
    ...
    def test_is_not_enrolled(self):
        ...
        test_class.add_student('Test Student2')
        test_class.add_student('Test Student3')
        self.assertFalse(test_class.is_enrolled('Test Student4'))
    ...
    def test_index_of_student_add(self):
        test_class = ClassList(2)
        test_class.add_student('Test Student')
        test_class.add_student('Test Student2')
        test_class.add_student('Test Student3')
        self.assertIsNone(test_class.index_of_student('Test Student4'))
